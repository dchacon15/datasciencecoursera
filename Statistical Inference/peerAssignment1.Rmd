...
```{r ListToDataframe, results="hide",warning=FALSE}
dat <- data.frame(values = avgMeans)
```

```{r HistogramDist, fig.align='center', fig.height=4, fig.width=5}
library(ggplot2)
